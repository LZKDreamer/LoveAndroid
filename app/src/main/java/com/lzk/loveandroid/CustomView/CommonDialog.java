package com.lzk.loveandroid.CustomView;
...
public class CommonDialog extends Dialog
{
	...
	public CommonDialog(Context context, String titleMsg, String contentMsg, String confirmText,
                        DialogClickListener confirmListener)
	{
		this(context, titleMsg, contentMsg, confirmText, null, CommonUtil.dip2px(context, 260), confirmListener, null);
	}
	...
	{
		this(context, msg, contentMsg, confirmText, cancelText, CommonUtil.dip2px(context, 260), confirmClick, null);
	}
